...
def load_data(opt):
    ...
    query_dataset = NUS_WIDE('query', transform=test_img_transform())
    train_dataset = NUS_WIDE('train', transform=train_img_transform())
    database_dataset = NUS_WIDE('all', transform=test_img_transform())
